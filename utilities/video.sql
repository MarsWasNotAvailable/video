...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 10, 2023 at 07:47 AM
...
(4, 'guest', 'Mr Beany', 'mrbean@uk.co.uk', 'bean');
...
(4, 4, 'I recently bought a bike.', '2013-08-01 00:00:00', 'mrbean_new_hobby.mp4', 'I am training for a competition next month.', 1),
...
(10, 4, 'I received a trophy', '2023-08-31 00:00:00', 'mrbean_button.mp4', 'yay !', 1),
...
(13, 4, 'Sans titre', '2023-08-10 11:45:49', NULL, 'Ajouter un résumé ici.', 0),
(14, 4, 'Sans titre', '2023-08-10 11:46:43', NULL, 'Ajouter un résumé ici.', 0);
...
ALTER TABLE `commentaire`
  ...
  ADD CONSTRAINT `commentaire_video` FOREIGN KEY (`fk_video`) REFERENCES `videos` (`id_video`) ON DELETE NO ACTION ON UPDATE NO ACTION;
